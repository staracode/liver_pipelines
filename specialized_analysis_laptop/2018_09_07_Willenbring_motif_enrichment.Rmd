...
y_classifier [ which(genes2[index, "False.discovery.rate"] <0.01)] <- 1
mean = mean(genes2[index, "False.discovery.rate"],na.rm=T)
y_classifier [which(genes2[index, "False.discovery.rate"] <mean & genes2[index, "False.discovery.rate"] >=0.01)] <- NA
table(y_classifier)
y_classifier2 = y_classifier[which(!is.na(y_classifier))]
table(y_classifier2)
