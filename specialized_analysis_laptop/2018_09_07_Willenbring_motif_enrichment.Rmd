...
writeXStringSet(myseqs_background, "~/Downloads/background_promoters.fa", format="fasta")
myseqs_background
myseqs_foreground = get_promoter_sequences (data_DE2[which(data_DE2$False.discovery.rate.1 < 0.01),])
writeXStringSet(myseqs_foreground, "~/Downloads/foreground_promoters.fa", format="fasta")
myseqs_foreground
