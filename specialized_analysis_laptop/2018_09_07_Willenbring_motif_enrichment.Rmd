...
myseqs_foreground = get_promoter_sequences (data_DE2[which(data_DE2$False.discovery.rate.1 < 0.01),])
...
##meme foreground_promoters.fa -dna -oc . -nostatus -mod zoops -nmotifs 3 -minw 6 -maxw 12 -objfun de  -revcomp  -bfile ______

# meme/libexec/meme-5.0.2/fasta-get-markov -dna -m 2 
