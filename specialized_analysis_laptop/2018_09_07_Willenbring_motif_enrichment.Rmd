...
[1] 751
     ...
     fisher.test(data.frame(rbind(c(1729, 145), c(9436, 751))))
     
rbind(c(length(which(fg4n>0)), length(which(fg4n==0))), c(length(which(bg4n>0)), length(which(bg4n==0)) ))
[1] 145
> length(which(fg4n>0))
[1] 1729
> length(which(bg4n>0))
...
rbind(c(length(which(fg2n>0)), length(which(fg2n==0))), c(length(which(bg2n>0)), length(which(bg2n==0)) ))
