...
```{r}
filename1 = "~/Box Sync/laptop_folders/Duwaerts_Mattis/readcounts1.txt"
filename2 = "~/Box Sync/laptop_folders/Duwaerts_Mattis/readcounts2.txt"
filename3 = "~/Box Sync/laptop_folders/Duwaerts_Mattis/readcounts3.txt"
...
key1 = read.table("~/Box Sync/laptop_folders/Duwaerts_Mattis/Mattis_Duwaerts_metadata2.txt", header = T, stringsAsFactors = F, fill=T, sep="\t")
head(key1)
key2 = read.table("~/Box Sync/laptop_folders/Duwaerts_Mattis/Mattis_Duwaerts_metadata.txt", header = T, stringsAsFactors = F, fill=T, sep="\t")
head(key2)
...
ppp <- ppp + geom_point(size=3) + geom_text(aes(label=Condition3), nudge_y=6)
plot(ppp)
```
...
write.table(results, paste0("~/Box Sync/laptop_folders/Duwaerts_Mattis/duwaerts_mattis_de_", curr_date, ".xls"), row.names=rownames(counts_matrix_filtered), col.names=NA, sep="\t")
...
```{r}
curr_date = format(Sys.time(), "%a_%b_%d_%H_hrs_%M_min_%S_sec_%Y")
write.table(topGOResults2, paste0("~/Box Sync/laptop_folders/Duwaerts_Mattis/duwaerts_mattis_goresults_", curr_date, ".xls"),  col.names=NA, sep="\t")
