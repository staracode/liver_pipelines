...
#$ -o bowtie2_index_stdout                       #-- output directory (fill in)
#$ -e bowtie2_index_stderr                        #-- error directory (fill in)
...
INDEX_DIR=/netapp/home/tfriedrich/LiverCenter/genomes/hg38/ucsc/index/bowtie2/
